...
exports.HashMap = exports.ListNode = exports.HashMaps = void 0;
class HashMaps {
    constructor(size = 16) {
        this.size = size;
...
exports.HashMaps = HashMaps;
// With Collision
// Here we are going to adapting doubly linked list to hold old values (so they wont be overide) when setting new values
class ListNode {
    constructor(value) {
        this.value = value;
        this.next = null;
